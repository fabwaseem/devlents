...
const buttonVariants = cva(
  "text-base font-sans font-medium leading-6 -tracking-[0.3px] text-white  dark:text-white  relative z-0 before:-z-10  before:absolute before:bottom-0 before:left-0 before:h-full before:w-full before:origin-right before:scale-x-0 before:bg-borderColour-dark dark:before:bg-primary-200 before:transition-transform before:duration-500 before:hover:origin-left before:hover:scale-x-100 disabled:before:hover:scale-x-0  flex items-center  justify-center disabled:opacity-70 disabled:cursor-not-allowed overflow-hidden overflow-ellipsis whitespace-nowrap",
  {
    variants: {
      variant: {
        default:
        ...
        outline:
          "duration-500 transition-all hover:transition-all  bg-white text-paragraph border-borderColour dark:bg-transparent border dark:border-[#313330]  z-10 before:bg-paragraph dark:before:bg-primary hover:text-white disabled:hover:text-paragraph dark:disabled:hover:text-white",
